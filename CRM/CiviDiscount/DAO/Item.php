 ...
 * (GenCodeChecksum:d130f6838e94126abf4314078c29df63)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'membership_new' => [
          'name' => 'membership_new',
          'type' => CRM_Utils_Type::T_BOOLEAN,
          'title' => E::ts('Discount to New Member Only'),
          'where' => 'cividiscount_item.membership_new',
          'table_name' => 'cividiscount_item',
          'entity' => 'Item',
          'bao' => 'CRM_CiviDiscount_DAO_Item',
          'localizable' => 0,
        ...
        'membership_renew' => [
          ...
          'type' => CRM_Utils_Type::T_BOOLEAN,
          'title' => E::ts('Discount to Renew Member Only'),
          'where' => 'cividiscount_item.membership_renew',
          'table_name' => 'cividiscount_item',
          'entity' => 'Item',
          'bao' => 'CRM_CiviDiscount_DAO_Item',
          'localizable' => 0,
